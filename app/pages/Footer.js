    ...
    <>
      <footer className="footer bg-yellow-400 text-base-content p-12 mt-20">
        <aside className="mx-auto">
          <img className="w-32" src="assets/logo/LOGO-GERAI-PANGLIMA-02.jpg" />
          <ul className="flex gap-2 -mt-5">
            <li className="gap-2 lg:text-xl font-semibold pt-3">
              <Link
                target="_blank"
          ...
          <p>©2024 Gerai Panglima. All Rights Reserved.</p>
        </aside>
        <nav>
