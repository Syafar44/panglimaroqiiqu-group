...
const KontakPanglima = () => {
  return (
    <>
      <Navbar />
      <section className="hero mt-20 h-52 lg:h-72 lg:mt-32">
      ...
      <section>
        <div className="mx-5 lg:mx-44 xl:mx-80 text-start mb-5 lg:mb-20">
      ...
      <section className="mx-5 lg:mx-44 xl:mx-80 border shadow-xl rounded-lg p-10">
        <subsection>
